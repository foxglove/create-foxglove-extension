...
function ExamplePanel({ context }: { context: PanelExtensionContext }): JSX.Element {
  ...
  return (
    <div className="bg-white p-4 flex flex-col gap-4 max-h-full overflow-y-scroll">
      <div className="font-mono text-center">
        <h2 className="text-xl">Welcome to your new extension panel</h2>
        <h3 className="text-lg">with Tailwind CSS styling.</h3>
      </div>
      ...
      <div className="grid grid-cols-2 gap-y-1">
        <b className="border-b py-1">Topic</b>
        <b className="border-b py-1">Datatype</b>
        {(topics ?? []).map((topic) => (
          <>
